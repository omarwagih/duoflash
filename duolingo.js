...
class Duolingo {
     ...
     */
    async getData () {
        const URL = `https://www.duolingo.com/users/${this.userName}`;
        try{
     ...
     */
    async getVocabulary() {
        const URL = `https://www.duolingo.com/vocabulary/overview`;
        try{
            let result = await this.apiRequest('GET', URL)
            return result.data;
        }catch(e){
    ...
    async switchLanguage(lang){
        const URL = `https://www.duolingo.com/switch_language`
